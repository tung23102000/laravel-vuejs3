                        ...
                        <div class="col-xs-11">
                            <form @submit.prevent="updatedPost" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img class='img-responsive' width="102"
                             v-bind:src="'../../'+post.post_image" alt='image' />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="post_author" v-model="post.post_category">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="post_author" v-model="post.post_author">
                                </div>
                                ...
                                <div class="form-group">
                                    <input class="btn btn-success" type="submit" name="create" value="Sửa bài viết">
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    methods: {
        ...
        async updatedPost() {
            ...
            if (!this.errors.length) {
                ...
                formData.append("post_category", this.post.post_category);
